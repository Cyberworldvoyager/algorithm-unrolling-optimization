...
4. **LISTA-Momentum 泛化性最佳**：OOD 退化仅 1.01×，但精度未超越 ISTA
...
| **LISTA-Momentum** | **0.657** | **0.662** | **1.01×** | **泛化最佳 (展开网络)** |
...
- **LISTA-Momentum 泛化性最佳**：退化仅 1.01×，因为每层用当前 A 计算梯度，不把 A 固化在权重中
...
4. **LISTA-Momentum 的泛化性设计有效**：
   - OOD 退化仅 1.01×（最佳），因为每层用当前 A 计算梯度
